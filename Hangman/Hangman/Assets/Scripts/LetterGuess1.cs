...
public class LetterGuess1 : MonoBehaviour {
	...
	void Start () {
		...
		words = new string[] {"PACIFIC", "TEACHER", "STUDENT", "COLLEGE", "SURGERY", "VILLAGE"};
		hints = new string[] { "OCEAN", "EDUCATION", "EDUCATION", "EDUCATION", "MEDICAL", "LIVING" };
